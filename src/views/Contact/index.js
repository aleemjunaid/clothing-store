...
const Contact = ()=> {
  return (
    ...
    <div className="w-full flex items-center justify-center my-12">
        <form onSubmit={(e) => e.preventDefault} className="absolute top-40 bg-white dark:bg-gray-800 shadow rounded py-16 lg:px-28 px-8">
            ...
            <div>
                <div className="w-full flex flex-col mt-8">
                    ...
                    <textarea tabIndex="0" aria-label="leave a message" type="name" className="h-36 text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100 resize-none"></textarea>
                </div>
            </div>
